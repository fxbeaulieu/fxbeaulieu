...
2. Python 🐍
   - Surtout pour dev notre application multimodèles servant à interagir avec les divers modèles AI internes (hébergé dans Azure OpenAI) 🤖☁️
